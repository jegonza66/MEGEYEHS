...
for mssh, mssl in [(4, 2), (2, 1)]:
    ...
    for subject_code in exp_info.subjects_ids:
        ...
        try:
            ...
            # mssl
            mssl_ms_window_times = (0, mss_duration[mssl])
        ...
        # ITC topoplot
        # MS
        fig = itc_diff_ms.plot_topo(cmap='jet', show=display_figs, title='Inter-Trial coherence')
        if save_fig:
    ...
    plot_general.tfr(tfr=grand_avg_itc_ms_diff, chs_id=chs_id, epoch_id=epoch_id, mss=mss, cross1_dur=cross1_dur, mss_duration=mss_duration,
