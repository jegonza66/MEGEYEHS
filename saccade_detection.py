...
class online_sac_detect:
    ...
    def __init__(self, lib_name='detect_saccade.so',
                 lib_path='/mnt/6a6fd40a-e256-4844-8004-0e60d95969e8/MEGEYEHS/MEGEYEHS_Python/Saccade_Detection_C/'):
...
if __name__ == '__main__':
    ...
    sac_data = np.genfromtxt('Saccade_Detection_C/example_saccade.csv', delimiter=',')
    x_sac = sac_data[:, 2]
    y_sac = sac_data[:, 3]
    ...
    import saccade_detection

    detect_this = saccade_detection.online_sac_detect()
