...
meg_params = {'chs_id': 'mag',
              'band_id': None,  # None for no filtering / 'Alpha' / 'Beta' / 'Theta' / 'Delta' / 'Gamma' / 'HGamma' or custom (l_freq, h_freq)
              'filter_sensors': True,
              'filter_method': 'iir',
              'data_type': 'ICA',
              'downsample': 300
    ...
    for param_value in param_values[param]:
        ...
        for subject_code in exp_info.subjects_ids:
            ...
            # Estimate sources from evoked
                ...
                feature_evokeds = functions_analysis.parse_trf_to_evoked(subject=subject, rf=rf, meg_data=meg_data, trf_params=trf_params, meg_params=meg_params, feature_evokeds=feature_evokeds)
