...
for subject_code in exp_info.subjects_ids:
    ...
    epochs_save_path = save_path + f'Epochs/{epoch_id}/' + subject.subject_id + '/'
    ...
    # Plot evoked
    plot_general.evoked(subject=subject, evoked_meg=evoked_meg, evoked_misc=evoked_misc, epoch_id=epoch_id,
                        picks=picks, chs_id=chs_id, filter_evoked=filter_evoked, l_freq=l_freq, h_freq=h_freq,
                        plot_gaze=True, plot_xlim=plot_xlim, display_figs=display_figs, save_fig=False)
